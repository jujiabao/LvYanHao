 ...
 * @author 陈靖
 */
public class FilmDetailPullToRefreshLayout extends RelativeLayout
{
	...
	public FilmDetailPullToRefreshLayout(Context context)
	{
		super(context);
		initView(context);
	}

	public FilmDetailPullToRefreshLayout(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		initView(context);
	}

	public FilmDetailPullToRefreshLayout(Context context, AttributeSet attrs, int defStyle)
	{
			...
			AsyncTask<Integer, Float, String>
	{
		...
		protected void onPostExecute(String result)
		{
			...
			if (mListener != null)
				...
				mListener.onRefresh(FilmDetailPullToRefreshLayout.this);
			hide();
		}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		...
		filmDetailView.layout(0,
				(int) (pullDownY + pullUpY),
				filmDetailView.getMeasuredWidth(), (int) (pullDownY + pullUpY)+filmDetailView.getMeasuredHeight());

		pullableView.layout(0, (int) (pullDownY + pullUpY)+filmDetailView.getMeasuredWidth(),
				pullableView.getMeasuredWidth(), (int) (pullDownY + pullUpY)
						+ pullableView.getMeasuredHeight()+filmDetailView.getMeasuredWidth());
		loadmoreView.layout(0,
				(int) (pullDownY + pullUpY) + pullableView.getMeasuredHeight()+filmDetailView.getMeasuredWidth(),
				loadmoreView.getMeasuredWidth(),
				(int) (pullDownY + pullUpY) + pullableView.getMeasuredHeight()
						+ loadmoreView.getMeasuredHeight()+filmDetailView.getMeasuredWidth());
	}
	...
	public interface OnRefreshListener
	{
		 ...
		 * 刷新操作
		 */
		void onRefresh(FilmDetailPullToRefreshLayout pullToRefreshLayout);

		/**
		 * 加载操作
		 */
		void onLoadMore(FilmDetailPullToRefreshLayout pullToRefreshLayout);
	}
